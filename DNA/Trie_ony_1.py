...
class TrieT:
    ...
    # first = 1
        ...
        for i, (gene, health) in enumerate(zip(genes, healths)):
            ...
            cur.healths[i] = health  # assigning a health for the specific gene when we reach the end of the word
            cur = self.root
    ...
    def build_failures(self):
        ...
        while not self.queue.empty():
            ...
            # child.failure = node for child in node.dict.values
                    ...
                    child_node.healths.update(child_node.failure_node.healths)
    ...
    def calc_health(self, strand, first, last):
        ...
        while not end:
            if s in cur.children:
                ...
                for health_index, health_value in cur.healths.items():
